            ...
            <div className="container h-auto p-6 mx-auto mt-28 lg:mt-52">
                <div className="grid grid-col-1 lg:grid-cols-2 gap-5">
                    <div className="mt-4 mb-4">
                        ...
                        <button className="mt-3 items-center justify-center rounded-sm px-7 py-3 outline-none lg:transition-all  lg:hover:scale-90  bg-[#02514b] flex gap-3 text-white">
