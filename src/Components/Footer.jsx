    ...
    <>
      <div className="h-42 p-10 md:p-8 lg:p-10  mt-60 bg-slate-950 ">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 md:grid-cols-2">
          <div className=" my-4">
            <h2  data-aos="fade-up" className="text-white text-lg lg:text-3xl font-bold uppercase">
            ...
            <div className="flex items-center mt-4 mb-4 gap-5">
              <div  data-aos="fade-up" className="rounded-full lg:h-10 lg:w-10 h-8 w-8 flex items-center justify-center p-2 md:p-4 lg:p-4 bg-gray-200 lg:hover:bg-slate-800 lg:hover:text-yellow-500">
